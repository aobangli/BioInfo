...
load('.\\LIHC_Count_expMatrix.Rdata')


######### 样本筛选 ##########
library(stringr)
sampletype= substr(colnames(LIHC_Count_expMatrix),14,15)
LIHC_PT_COUNT_expr= LIHC_Count_expMatrix[,sampletype=='01']
LIHC_CN_COUNT_expr= LIHC_Count_expMatrix[,sampletype=='11']
...
countData <- LIHC_TN_COUNT_expr[c("PLA2G10","PLA2G2D","PLA2G2E","PLA2G3",
